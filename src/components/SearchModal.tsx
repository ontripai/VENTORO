  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-20 px-4 bg-black/80 backdrop-blur-sm animate-fade-in">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative w-full max-w-2xl bg-[#222c3d] border border-gold-500/50 rounded-xl shadow-2xl overflow-hidden z-10">
        {/* Search Input Bar */}
        <div className="flex items-center px-4 py-3.5 border-b border-slate-700 bg-[#161e2b]">
